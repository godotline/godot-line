...
const SET_MATERIAL_COLOR_SCRIPT: Script = preload("res://#Template/[Scripts]/Trigger/SetMaterialColor.gd")
const SEQUENCE_SCRIPT: Script = preload("res://addons/dancing_line_importer/scripts/sequence_trigger.gd")
const TELEPORT_SCRIPT: Script = preload("res://#Template/[Scripts]/Trigger/Teleport.gd")
...
const TRIGGER_CONFIG: Dictionary = {
	...
	5: {"label": "MoveTrigger", "childName": "EventTrigger", "animatorKind": "pos"}, # genius idea
...
const TRIGGER_FIELD_MAP: Dictionary = {
	...
	24: {"fields": [
		# 重力为世界空间方向向量：镜像关卡下 x 分量取反（通常仅 y 非零，取反无副作用）
		{"kind": "vecWhole", "prop": "gravity", "mirrorX": true},
	]},
}
